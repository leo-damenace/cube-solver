...
def analyze():
    ...
    num = len(images)
    prompt = (
        "You are solving a physical 4x4x4 Rubik's Revenge cube. "
        ...
        "Photos 3 and 4 are extra angles to fill in any missing stickers, each showing 2 faces. "
        ...
        "Notations for the directions. figure it out:\n"
